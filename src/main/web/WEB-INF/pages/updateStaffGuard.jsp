...
<fieldset style="padding-left: 10%;background: pink">
    ...
    <form action="updateStaffGuardServlet" method="post">
        <table>
            <tr>
                <td>
                    ...
                    <select id="position">
                        <option name="p_id" value="p_id">--职　位--</option>
                    </select>
                    <select name="s_id" id="staff">
                        <option name="s_id" value="s_id">--员　工--</option>
                    </select>
                </td>
                <td><input type="submit" value="换　岗"></td>
            </tr>
        </table>
    </form>
</fieldset>
