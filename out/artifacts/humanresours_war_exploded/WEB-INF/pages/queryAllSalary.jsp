...
<legend>查看薪资</legend><br/>
<form action="" method="post">
<table>
    <c:forEach items="${requestScope.salaries}" var="salaries" varStatus="loop">
        <tr>
            <td></td>
            <td><input type="hidden" name="sl_id" value="${salaries.sl_id}"/></td>
        </tr>
        <tr>
            <td>工　　号:</td>
            <td>${salaries.s_id}</td>
        ...
        <tr>
            <td><a href="updateSalary?sl_id=${salaries.sl_id}">修　　改</a></td>
            <td><a href="deleteSalaryServlet?sl_id=${salaries.sl_id}">删　　除</a></td>
        </tr>
    </c:forEach>
    </table>
    </form>
